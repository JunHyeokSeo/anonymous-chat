package com.anonymouschat.anonymouschatserver.presentation;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<CommonResponse<Void>> handleCustomException(AbstractCustomException ex) {
	...
	public ResponseEntity<CommonResponse<Void>> handleMissingParameter(MissingServletRequestParameterException e) {
	...
	public ResponseEntity<CommonResponse<Void>> handleUnhandled(Exception e) {
