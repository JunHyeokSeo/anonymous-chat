...
class GetMyProfileUseCaseTest {
	...
	void getMyProfileUseCase_success() {
		...
		GetMyProfileServiceResponse mockResponse = GetMyProfileServiceResponse.builder()
				                                           .id(user.getId())
		...
		// when
		GetMyProfileUseCaseResponse result = useCase.getMyProfile(OAuthProvider.GOOGLE, "abc123");
